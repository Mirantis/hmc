...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NameContract) DeepCopyInto(out *NameContract) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NameContract.
func (in *NameContract) DeepCopy() *NameContract {
	if in == nil {
		return nil
	}
	out := new(NameContract)
	in.DeepCopyInto(out)
	return out
}
