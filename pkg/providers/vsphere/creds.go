...
func generateVSphereCCMConfigs(vCl *capv.VSphereCluster, vScrt *corev1.Secret, vMa *capv.VSphereMachine) (*corev1.Secret, *corev1.ConfigMap, error) {
	...
	return credspropagation.MakeSecret(secretName, metav1.NamespaceSystem, secretData),
		credspropagation.MakeConfigMap("cloud-config", metav1.NamespaceSystem, cmData),
		nil
}
...
`
	...
	return credspropagation.MakeSecret("vcenter-config-secret", metav1.NamespaceSystem, secretData), nil
}
